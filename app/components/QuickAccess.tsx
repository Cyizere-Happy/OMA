    ...
    <section className="px-8 py-4">
      <div className="border-l-4 border-[#1E3A5F] pl-5 py-1 mb-6">
        <div className="flex flex-wrap items-center gap-3">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-600 bg-stone-200/90 px-2 py-1 rounded border border-stone-300">Field</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
        {statCards.map((s) => (
          <div key={s.label} className="flex items-center gap-4 p-4 bg-white border border-stone-300 rounded-r-xl border-l-4 border-l-[#1E3A5F] shadow-[0_2px_0_rgba(28,25,23,0.04)]">
